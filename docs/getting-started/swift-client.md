...
This page walks you from `primitive init --platform ios` through a working app, then into data modeling, the API surface, and shipping. (For the two-platform overview — web and iOS — see the [Quick Start](./template-app.md).)
